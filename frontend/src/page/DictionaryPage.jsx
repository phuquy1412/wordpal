...
const useDictionary = () => {
  ...
  // Dữ liệu giả lập cho các từ
  const mockApiData = {
    hello: [{
      word: "hello",
      phonetic: "/həˈləʊ/",
      phonetics: [{ text: "/həˈləʊ/", audio: "https://api.dictionaryapi.dev/media/pronunciations/en/hello-us.mp3" }],
      origin: "Early 19th century: variant of hallo.",
      meanings: [
        {
          ...
          definitions: [
            {
              ...
              synonyms: ["hi", "greetings", "good morning", "good afternoon", "good evening"],
    ...
    beautiful: [{
      word: "beautiful",
      phonetic: "/ˈbjuːtɪfʊl/",
      phonetics: [{ text: "/ˈbjuːtɪfʊl/", audio: "https://api.dictionaryapi.dev/media/pronunciations/en/beautiful-us.mp3" }],
      meanings: [
        {
    ...
    knowledge: [{ word: "knowledge", phonetic: "/ˈnɒlɪdʒ/", phonetics: [{ text: "/ˈnɒlɪdʒ/", audio: "https://api.dictionaryapi.dev/media/pronunciations/en/knowledge-us.mp3" }], meanings: [{ partOfSpeech: "noun", definitions: [{ definition: "Facts, information, and skills acquired through experience or education; the theoretical or practical understanding of a subject." }] }] }],
    success: [{ word: "success", phonetic: "/səkˈsɛs/", phonetics: [{ text: "/səkˈsɛs/", audio: "https://api.dictionaryapi.dev/media/pronunciations/en/success-us.mp3" }], meanings: [{ partOfSpeech: "noun", definitions: [{ definition: "The accomplishment of an aim or purpose." }] }] }],
    serendipity: [{ word: "serendipity", phonetic: "/ˌsɛr(ə)nˈdɪpɪti/", phonetics: [{ text: "/ˌsɛr(ə)nˈdɪpɪti/", audio: "" }], meanings: [{ partOfSpeech: "noun", definitions: [{ definition: "The occurrence and development of events by chance in a happy or beneficial way." }] }] }],
    ephemeral: [{ word: "ephemeral", phonetic: "/ɪˈfɛm(ə)r(ə)l/", phonetics: [{ text: "/ɪˈfɛm(ə)r(ə)l/", audio: "" }], meanings: [{ partOfSpeech: "adjective", definitions: [{ definition: "Lasting for a very short time." }] }] }],
    eloquent: [{ word: "eloquent", phonetic: "/ˈɛləkwənt/", phonetics: [{ text: "/ˈɛləkwənt/", audio: "" }], meanings: [{ partOfSpeech: "adjective", definitions: [{ definition: "Fluent or persuasive in speaking or writing." }] }] }],
    resilient: [{ word: "resilient", phonetic: "/rɪˈzɪlɪənt/", phonetics: [{ text: "/rɪˈzɪlɪənt/", audio: "" }], meanings: [{ partOfSpeech: "adjective", definitions: [{ definition: "Able to withstand or recover quickly from difficult conditions." }] }] }],
    aesthetic: [{ word: "aesthetic", phonetic: "/iːsˈθɛtɪk/", phonetics: [{ text: "/iːsˈθɛtɪk/", audio: "" }], meanings: [{ partOfSpeech: "adjective", definitions: [{ definition: "Concerned with beauty or the appreciation of beauty." }] }] }],
  };
  ...
  const lookupWord = (word) => {
    ...
    // Mô phỏng gọi API
    setTimeout(() => {
      const data = mockApiData[word.toLowerCase()];
      if (data) {
        setWordData(data);
      } else {
        setError(`Xin lỗi, không tìm thấy định nghĩa cho từ "${word}". Vui lòng thử lại.`);
      }
      setIsLoading(false);
...
const DictionaryPage = () => {
  ...
  // Sử dụng hook giả lập đã tạo ở trên
  const {
    lookupWord,
    wordData,
    isLoading,
